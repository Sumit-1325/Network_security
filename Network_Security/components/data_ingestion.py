...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            with pymongo.MongoClient(mongoDbUrl) as client:
                collection = client[database_name][collection_name]
                data = list(collection.find())  # Fetch inside the context
    ...
    def export_data_into_feature_store(self,df:pd.DataFrame):
        try:
            logging.info(f"Exporting data into feature store")
            ...
            logging.info(f"Data exported as csv file: {Feature_File_Path}")
    ...
    def initiate_data_ingestion(self):
        try:    
            ...
            self.export_data_into_feature_store(df=df)
            ...
            logging.info(f"Data Ingestion artifact: {dataingestion}")
